...
namespace Nymbus.Domain.Migrations
{
    ...
    [Migration("20180823205231_UserEvents")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nymbus.Domain.Entities.ArtistFollower", b =>
                {
            ...
            modelBuilder.Entity("Nymbus.Domain.Entities.ClapToPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("EventArtistId");

                    b.HasIndex("SetSongId");

                    b.ToTable("ClapToPosts");
                });

            modelBuilder.Entity("Nymbus.Domain.Entities.ClapToPostImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("ClapToPostId");
                    ...
                    b.HasIndex("ClapToPostId");

                    b.ToTable("ClapToPostImages");
                });
            ...
            modelBuilder.Entity("Nymbus.Domain.Entities.EventNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Nymbus.Domain.Entities.SponsorLocationContentPromotion", b =>
                {
                    ...
                    b.HasKey("SponsorLocationId", "ContentPromotionId");
            ...
            modelBuilder.Entity("Nymbus.Domain.Entities.UserContentPromotion", b =>
                {
                    b.Property<int>("UserId");

                    b.Property<int>("ContentPromotionId");

                    b.Property<int>("UnlockedCount");

                    b.Property<DateTimeOffset>("UnlockedUntil");

                    b.HasKey("UserId", "ContentPromotionId");

                    b.HasIndex("ContentPromotionId");

                    b.ToTable("UserContentPromotions");
                });

            modelBuilder.Entity("Nymbus.Domain.Entities.UserEvent", b =>
                {
                    b.Property<int>("UserId");
            ...
            modelBuilder.Entity("Nymbus.Domain.Entities.ClapToPost", b =>
                {
                    b.HasOne("Nymbus.Domain.Entities.EventArtist", "EventArtist")
                        .WithMany()
                        .HasForeignKey("EventArtistId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Nymbus.Domain.Entities.SetSong", "SetSong")
                        .WithMany()
                        .HasForeignKey("SetSongId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("Nymbus.Domain.Entities.ClapToPostImage", b =>
                {
                    b.HasOne("Nymbus.Domain.Entities.ClapToPost", "ClapToPost")
                        .WithMany("Images")
                        .HasForeignKey("ClapToPostId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Nymbus.Domain.Entities.UserContentPromotion", b =>
                {
                    ...
                    b.HasOne("Nymbus.Domain.Entities.User", "User")
                        .WithMany("UnlockedContentPromotions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
